        ...
        <div class="printableArea">    
            ...
            <div class="invoice_header etat_header">
                <div class="row model1">
                    ...
                    <p>{{ $order->serviceProfile->address . ' ' . $order->serviceProfile->city . ' ' . $order->serviceProfile->country . '-' . $order->serviceProfile->zip_code }} <br>
            ...
            <tbody>
                ...
                @foreach ($order->orderItems as $item)
                    <tr>
                        ...
                        <td class="text-md-left">{{ $item->quantity }}</td>    
            ...
            <tr>
                ...
                @endphp
            <td colspan="5"><span style="font-weight: bold;">In Word: {{$f->format($total_price )}}</td>
            </tr>
            <tr>
