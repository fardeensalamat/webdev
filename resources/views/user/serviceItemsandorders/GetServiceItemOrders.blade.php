        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="card-title"> {{__('orderdashboard.given_service_orders')}}</div>
                </div>
                <div class="card-body">
                           ...
                           <tr>
                            ...
                            <td>
                                <div class="btn-group btn-sm">
                                  <a href="{{ route('user.ServieItemOrderDetails',['order'=>$order->id,'type'=>'user']) }}" class="btn btn-success">Details</a>
                                </div>
                            </td>
