...
{{--                                                <button onclick="getLocationse()" class="get_location">Set Location</button>--}}
{{--                                                <form action="{{route('user.employeeReport.Status')}}" method="post"> @csrf--}}
{{--                                                    <input type="hidden" name="id" value="{{$data->id}}">--}}
{{--                                                    <input required style="width: 0px !important; border: none !important;" name="last_location" id="last_location" readonly>--}}
{{--                                                    <button type="submit" data-id="{{$data->id}}" class="btn btn-success report_close">Close</button>--}}
