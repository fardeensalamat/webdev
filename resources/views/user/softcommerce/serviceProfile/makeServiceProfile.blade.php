                    ...
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-briefcase text-primary"></i> 
                            <span
                                ...
                                {{__('userserviceprofile.add_new_service_business_profile')}}
                    ...
                    <div class="card-body" style="min-height: 200px;">
                        <div class="container">
                            <div class="row ">
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-header w3-blue"> {{__('userserviceprofile.enter_existing_user')}}</div>
                                        <div class="card-body">
                                            ...
                                            <form method="post" id="myform" action="{{ route('user.storeServiceProfileFromUser') }}"
                                                ...
                                                <div class="input-group mb-3">
                                                    <select id="user" name="user" 
                                                        ...
                                                        data-placeholder="{{__('userserviceprofile.mobile')}}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-3">
                                                            <select name="workstation" id="workstation"
                                                                ...
                                                                <option value="">{{__('userserviceprofile.select_workstation')}}</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-3">
                                                            <select name="category" id="category" class="form-control"
                                                                ...
                                                                <option value="">{{__('userserviceprofile.select_category')}}</option>

                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 my-2">
                                                        <label for="location-input">{{__('userserviceprofile.google_location')}}</label>
                                                        <input type="text" name="location" placeholder="{{__('userserviceprofile.enter_your_location')}}" class="form-control pac-target-input"  id="location-input" placeholder="Google Location" autocomplete="off" required>
                                ...
                                <div class="col-md-6" id="hideShow" style="display: none;">
                                    <div class="card">
                                        <div class="card-header">{{__('userserviceprofile.create_new_tenant')}}</div>
                                        ...
                                        <div class="card-body">
                                            <form method="POST" action="{{ route('user.makeUserCreateForServiceProfile') }}" id="tenant-form" name="tenant-form">
                                                ...
                                                <div class="form-group row">
                                                    <label for="name"
                                                        class="col-md-4 col-form-label text-md-right">{{__('userserviceprofile.full_name')}}</label>

                                                    <div class="col-md-6">
                                                        <input id="name" name="name" type="text" placeholder="{{__('userserviceprofile.enter_your_full_name')}}" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus required>
                                                ...
                                                <div class="form-group row">
                                                    <label for="email"
                                                        class="col-md-4 col-form-label text-md-right">{{__('userserviceprofile.workstation')}}</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="mobile"
                                                        class="col-md-4 col-form-label text-md-right">{{ __('userserviceprofile.mobile') }}</label>

                                                    <div class="col-md-6">
                                                        <input id="mobile" type="text" placeholder="{{__('userserviceprofile.enter_valid_number')}}" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" autocomplete="mobile" autofocus required>
                                                ...
                                                <div class="form-group row">
                                                    <label for="password"
                                                        class="col-md-4 col-form-label text-md-right">{{ __('userserviceprofile.password') }}
                                                    </label>

                                                    <div class="col-md-6">

                                                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password"  autocomplete="new-password" placeholder="{{__('userserviceprofile.enter_password')}}" required>
                                                ...
                                                <div class="form-group row">
                                                    <label for="password-confirm"
                                                        class="col-md-4 col-form-label text-md-right">{{__('userserviceprofile.confirm')}}
                                                    </label>

                                                    <div class="col-md-6">
                                                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" autocomplete="new-password" placeholder="{{__('userserviceprofile.confirm_placeholder')}}" required>
                                                    </div>
