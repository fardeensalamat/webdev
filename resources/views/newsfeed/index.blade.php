...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-light" style="background: #4caf50">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index3.html" class="nav-link w3-text-white">Softcode</a>
      </li>
  ...
  <!-- Main Sidebar Container -->
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-2">
      <!-- Brand Logo -->
      <a href="{{ url('/') }}" class="brand-link" style="background: #4caf50">
          
          <span class="w3-text-white"><b>{{ env('APP_NAME') }}</b></span>
      </a>
          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact" data-widget="treeview"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                  <a href="{{route('welcome.newsfeed')}}" class="nav-link ">
                  ...
                  <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item ">
                          <a href="{{route('welcome.allnews',['workstation' => $ws])}}" target="_blank"
                        ...
                        @if ($ws->categories()->count() > 0)
                            @foreach ($ws->categories as $wscat)
                              <li class="nav-item ">
                                <a href="{{route('welcome.workstationCategoryNews',[ $ws, 'cat' => $wscat])}}" target="_blank"
                                    class="nav-link {{ session('lsbsm') == 'dashboard' ? ' active ' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>{{ $wscat->name }}</p>
                                </a>
