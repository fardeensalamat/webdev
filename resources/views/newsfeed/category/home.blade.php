@extends('newsfeed.layouts.master')
@section('content')
    <br>
<div class="content mt-2">
    ...
    <div class="row">
        <div class="col-md-8 col-offset-1">
            ...
            @if($mysubscribe)
            <form action="{{route('newsfeed.updateWorkStationCategory',['workstation'=>$workstation,'cat' => $category,'post'=>$post])}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
