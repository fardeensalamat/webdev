    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                <div class="h1 bold text-white">Blog</div>
            </div>
            <div class="col-md-4 order-1 order-md-2 align-self-center">
                <ul class="breadcrumb d-block text-md-right breadcrumb-light">
                    <li><a href="/">Home</a></li>
                    <li class=""> <a href="{{ route('welcome.blog',['type'=>'blog']) }}">Blog</a> </li>
                    <li class="">{{ mb_substr($blog->title,0,30) }}</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="blog-posts single-post">
                    ...
                    <article class="post post-large blog-single-post border-0 m-0 p-0">
                        ...
                        <div class="post-content ml-0">
                            ...
                            <div class="post-meta">
                                <span><i class="far fa-user"></i> By <a href="#">{{ $blog->user ? $blog->user->name : '' }}</a> </span>
                                    ...
                                    <span><i class="fas fa-tags"></i>
                                        ...
                                        @if ($tags)
                                            @foreach ($tags as $tag)
                                            <a
                                            href="{{ route('welcome.tagWisePost', ['type' => 'blog','tag'=>1, 'title' => $tag]) }}">{{ $tag }}</a>,
                                            @endforeach
                                        @endif
                            ...
                            <div class="post-block mt-4 pt-2 post-author">
                                ...
                                <div class="img-thumbnail img-thumbnail-no-borders d-block pb-3">
                                    <a href="#">
                                        <img src="{{ route('imagecache', ['template' => 'ppmd', 'filename' => $blog->user->fi()]) }}" alt="">
                                    </a>
                                </div>
                                <p><strong class="name"><a href="#" class="text-4 pb-2 pt-2 d-block">{{ $blog->user? $blog->user->name :null }}</a></strong></p>
