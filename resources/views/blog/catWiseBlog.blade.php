            ...
            <div class="row">
                ...
                <div class="col-md-4 order-1 order-md-2 align-self-center">
                    <ul class="breadcrumb d-block text-md-right breadcrumb-light">
                        <li><a href="/">Home</a></li>
                        <li class=""><a href="{{ route('welcome.blog',['type'=>'blog']) }}">Blogs</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <aside class="sidebar">
                    ...
                    <ul class="nav nav-list flex-column mb-5">
                        @forelse ($categories as $category)
                            <li class="nav-item"><a class="nav-link {{ $category->id == $cat->id ? 'active' :null }}" href="{{ route('welcome.catWiseBlog',['cat'=>$category->id,'title'=>mySlug($category->name)]) }}">{{ $category->name }}
            ...
            <div class="col-lg-9 order-lg-1">
                <div class="blog-posts">
                    @forelse ($cat->catwisePost('blog') as $blog)
