                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-left" style="border-radius: 15px;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                                    ...
                                    <div style="display:flex;">
                                        ...
                                        <button type="button" class="btn  btn-lg m-2" style="border-radius: 50px;">
...
{{--                    <h1  style="margin-top:80px; margin-left:10px; float:left;">SOFT COMMERCE</h1>--}}
            ...
            <div class="col-12" style="margin-top: -33px;">
                <center>
                    <div class="bar"  style="position:relative;">
                        <input class="searchbar computer-searchbar" type="text" style="color:black !important;" id="user_name" name="user_name"   autocomplete="off">
                        <a href="#" class="search_icon_mobile" style="position:absolute; margin-top: 4px; margin-left: -7px;"> <img class="search" src="/vueimage/icon.svg" title="Search"></a>

                        <input class="searchbar mobile-searchbar" type="text" style="color:black !important;" id="user_name_mobile" name="user_name"   autocomplete="off">
            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    $('#user_name_mobile').on('keyup',function (e) {
                        $('#user_name_mobile').css('margin-top','-250px');
                        if($.trim($('#user_name_mobile').val()).length == 0){
