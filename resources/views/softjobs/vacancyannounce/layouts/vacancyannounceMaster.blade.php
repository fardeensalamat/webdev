...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed text-sm ">
    ...
    <div class="wrapper">
        ...
        @include('softjobs.vacancyannounce.layouts.vacancyannounceHeader')

        <!-- Admin Sidebar section -->
        @include('softjobs.vacancyannounce.layouts.vacancyannounceLeftSidebar')
        ...
        @include('softjobs.vacancyannounce.layouts.footer')
