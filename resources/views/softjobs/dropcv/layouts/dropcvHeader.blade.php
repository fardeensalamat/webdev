  ...
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark border-bottom-0" >
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Job Seeker Dashboard</a>
      </li>
      <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown">
      @php 
      $jobseeker=\App\Models\Jobseeker::where('user_id',Auth::user()->id)->first();
     @endphp
      <a class="nav-link" data-toggle="dropdown" href="#"><i class="fas fa-user-circle"></i>  {{$jobseeker->name}}</a>
