        ...
        <div class="row">
            ...
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">{{route('register',['reffer'=> $subscription->subscription_code])}} <br>
                  <button class="copyboard btn btn-primary btn-xs" data-text="{{route('register',['reffer'=> $subscription->subscription_code])}}">Copy to Clipboard</button>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box">
              ...
              <a href="{{ route('subscriber.myReferrerTeam', $subscription->subscription_code) }}">

              <div class="info-box-content">
                <span class="info-box-text">My Referred Team</span>
                <span class="info-box-number">
