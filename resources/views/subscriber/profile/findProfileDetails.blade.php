            ...
            @elseif ($business_type == 'service')
                <div class="col-md-10 m-auto">
                        ...
                        <div class="bg-white shadow rounded overflow-hidden">
                            ...
                            <div class="bg-light p-4 d-flex justify-content-end text-center">
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item">
                                        <h5 class="font-weight-bold mb-0 d-block">
                                            {{ count($profile->serviceItems->where('status', 'approved')->where('active', true)) }}
                                        </h5>
                    ...
                    <div class="card card-widget">
                        ...
                        <div class="card-body w3-light-gray">
                            @if ($service_product)
                                @include('subscriber.serviceItems.include.items')
                ...
                <div class="card card-widget">
                    ...
                    <div class="card-body w3-light-gray">
                        ...
                        @foreach($rating as $rate)
                            ...
                            <span class="heading">{{$rate->user->name}} <b style="color: #f44336;">Rating</b></span>
                            <span class="fa fa-star @if($rate->rating>=1) checked @endif"></span>
                            <span class="fa fa-star @if($rate->rating>=2) checked @endif" ></span>
                            <span class="fa fa-star @if($rate->rating>=3) checked @endif"></span>
                            <span class="fa fa-star @if($rate->rating>=4) checked @endif"></span>
                            <span class="fa fa-star @if($rate->rating>=5) checked @endif"></span>
                            <p>{{$rate->comments}}</p>
                            @if(Auth::id()==$rate->user_id)
                             <a href="{{route('user.ratingdelete',$rate->id)}}" class="btn btn-danger">Delete</a>
                            @endif
                            <br>
                        @endforeach
                    </div>
