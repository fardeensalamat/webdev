                                        ...
                                        <form method="post" action="{{route('subscriber.subscriptionNewPostJob',[ 'subscription'=> $subscription->id,'worksation' => $subscription->work_station_id])}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="w3-border edit p-2 w3-round" id="instraction" style="white-space: pre-line;">{{$subcategory->instraction}}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label for="img" class="col-md-4 col-form-label text-md-right">{{ __('Image(Channel Screenshot)') }}</label>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="total_worker" type="number"  class="form-control @error('total_worker') is-invalid @enderror" name="total_worker" placeholder="Minimum One worker required" required autocomplete="total_worker" value='1' readonly>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="cost_per_worker" type="text" class="form-control @error('cost_per_worker') is-invalid @enderror" value='{{$subcategory->job_post_price}}' name="cost_per_worker" placeholder="Cost Per Worker" readonly autocomplete="cost_per_worker" autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input  id="estimate_day" type="date" class="form-control @error('estimate_day') is-invalid @enderror" name="estimate_day" placeholder="Minimum One worker required" value='{{$date}}' required autocomplete="estimate_day" autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="total_cost" type="text" class="form-control @error('estimate_cost') is-invalid @enderror" name="estimate_cost" value="{{$subcategory->job_post_price}}" autocomplete="estimate_cost" autofocus readonly value="BDT 10">
