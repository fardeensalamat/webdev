            ...
            <div class="invoice_header etat_header">
                <div class="row model1">
                    ...
                    <p style="width: 250px;">  <strong>Address:</strong> {{ $order->serviceProfile->address . ' ' . $order->serviceProfile->city . ' ' . $order->serviceProfile->country . '-' . $order->serviceProfile->zip_code }} <br>
                        ...
                        <strong>Web:</strong> https://www.sc-bd.com</p>
                    </div>
                    <div class="col-xs-4 invoice-header-info" id="inheight" style="height: 140px;">
                    ...
                    <br><strong>Deli. Man:</strong> {{$order->deliveryman->name ?? ''}} 
                    <br><strong>Deli. Phone:</strong> {{$order->deliveryman->phone ?? ''}} 
                    </div>
                </div>
            <hr>
