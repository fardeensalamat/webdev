                            ...
                            <tbody>
                                @forelse ($allOrders as $order)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('subscriber.orderDetailsOfCourse',['order'=>$order->id,'profile'=>$profile->id,'subscription'=>$subscription->subscription_code]) }}" class="btn btn-info btn-xs">Details</a></td>
                                    </tr>
                                @empty
                                <tr>
