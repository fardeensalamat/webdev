        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 m-auto">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.storeEditedTopPriority',$editData->id) }}" method="POST" id='my-form' enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                <div class="col-md-6">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <label class="form-label">From:</label>
                                            <input class="form-control" type="date" name="from" value="{{ $editData->from}}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class="form-label">To:</label>
                                            <input class="form-control" type="date" name="to" value="{{ $editData->to}}">
                                        </div>
                                    </div>
                                </div>
