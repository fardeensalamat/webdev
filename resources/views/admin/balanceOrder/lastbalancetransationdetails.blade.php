...
@section('content')
    <section class="content">
        ...
        <div class="printableArea">    
            ...
            <div class="invoice_header etat_header">
                <div class="row model1">
                    <div class="col-xs-3 invoice-logo">
                        <img src="{{ asset('storage/logo/' . $websiteParameter->logo_alt) }}" style="max-width: 150px;">
                    </div>
                    <div class="col-xs-5 invoice-header-info" id="adheight" style="height: 140px;">
                    <h4>{{ env('APP_NAME') }}</h4>
                    <p style="width: 250px;">  <strong>Address:</strong> {{ $websiteParameter->footer_address ?? '' }} <br>
                    {{-- <strong>Phone:</strong> 01303971179<br> --}}
                    <strong>Mobile:</strong> {{ $websiteParameter->contact_mobile ?? 'Not Available' }}<br>
                    <strong>Email:</strong> {{ $websiteParameter->contact_email ?? 'Not Available' }}<br>
                    <strong>Web:</strong> https://www.sc-bd.com</p></div>
                    <div class="col-xs-4 invoice-header-invoice" id="inheight" style="height: 140px;">
                    <strong>Name:</strong> {{ $user->name }}
                    <br><strong>Mobile:</strong> {{ $user->mobile }}  
                    <br><strong>Date:</strong>  {{ \Carbon\Carbon::today()->format('Y-m-d') }} 
                    <br><strong>Withdraw Amount:</strong>  {{ $amount }} 
                    </div>
                </div>
            <hr>
            ...
            <center>
            <h3 class="page-title">Last 10  Balance Transfer Report
            </h3>
            </center>
            ...
            <table class="table_invoice table_invoice-condensed table_invoice-bordered table_invoice-striped" style="margin-bottom: 5px;" cellpadding="0" cellspacing="0" border="0">
                ...
                <th style="width:12% !important; text-align:center;">Purpose</th>
                <th style="width:33% !important; text-align:center;">Details</th>
                <th style="width:12.5% !important; text-align:center;">Balance</th>
                </tr>
                </thead>
                <tbody>
                    ...
                    @foreach($details as $data)
                        ...
                        <tr>
                            ...
                            <td>{{$data->details}}</td>
                            <td  style="width:12.5% !important; text-align:right;">
                                {{ $data->moved_balance }}
                            </td>
                ...
                <tfoot>
                {{-- <tr>
                    <td colspan="2" style="font-weight: bold;text-align:center;">Withdraw Amount</td>
                    <td style="text-align:right;">BDT: {{ $amount }}</td>
                ...
                <tr>
                    ...
                    @endphp
                    <td colspan="4"><span style="font-weight: bold;">In Word: {{$f->format($amount )}}</td>
                </tr> --}}
