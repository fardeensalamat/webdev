        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 m-auto">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.storespeciallink') }}" method="POST" id='my-form' enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" value="" class="form-control" name="linktype" required>
                                            @error('linktype')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
