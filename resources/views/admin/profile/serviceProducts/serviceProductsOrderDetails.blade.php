...
@section('content')
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <span style="cursor: pointer;padding: 0 10px; font-size: large;" class="hide"
                        onClick="printdiv('div_print');" value=" Print "><i class="fa fa-print"></i></span>
                    <br>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <p><strong>Payment: </strong><span
                                    class="btn btn-info btn-xs">{{ $order->payment_status }}</span>
                            </p>
                        </div>
                ...
                <div class="table-responsive" id="bottomPart">
                                            ...
                                            @foreach ($order->orderItems as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span
                                                            class="badge badge-success w3-indigo">{{ $item->order_status }}
                                                        </span>
