                ...
                <div class="col-md-7">
                    <div class="card">
                        ...
                        <div class="product-description">
                            <div><span class="font-weight-bold">Seller:</span><span>{{ $product->serviceProfile->name }}</a></span>
                            </div>
                            ...
                            <div class="d-flex flex-row align-items-center">
                                <img src="{{ route('imagecache', ['template' => 'pfism', 'filename' => $product->serviceProfile->img_name]) }}"
                                        class="rounded-circle store-image shadow">
                                </a>
                                <div class="d-flex flex-column ml-1 comment-profile">
                                    <div class="comment-ratings"> {{ $product->category->name }} </div> <span
                                        class="username font-weigth-bold"> <a class="font-weigth-bold" href="#">{{ $product->serviceProfile->name }}</a>
