...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form
                    action="{{ route('admin.updatecourseItem', ['item' => $courseItem->id]) }}"
                    ...
                    @endif
                    <div class="form-group">
                        <label for="clink"> Cover Link</label>
                    ...
                    <div class="form-group">
                       ...
                       <select name="status" id="status" class="form-control">
                           ...
                           <option value="pending" @if($courseItem->status=='pending') selected @endif>Pending</option>
                           <option value="approved" @if($courseItem->status=='approved') selected @endif>Approved</option>
                           <option value="rejected" @if($courseItem->status=='rejected') selected @endif>Rejected</option>
                       </select>
                        @error('type')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
