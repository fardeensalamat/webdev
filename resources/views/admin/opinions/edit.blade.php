                ...
                <div class="card">
                    <div class="card-header bg-info">
                        <div class="d-flex justify-content-between">
                            <p class="pt-2 m-0"> Edit Opinion</p>
                            <p class="m-0">
                              <a href="{{ route('admin.opinions') }}" class="btn btn-xs btn-dark">Back</a>
                            </p>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-md-8 col-sm-12 m-auto">
                                <form action="{{ route('admin.updateOpinion') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="featured">
                                            <input type="checkbox" name="featured" id="featured" {{ $user_opinion->featured? 'checked' : null }}> Featured
                                        </label>
                                    </div>
                                    <div class="form-group">
