...
@section('content')
  @include('admin.honorariums.parts.edit')
@endsection
    ...
    $('#typeOfGlass').on('change', function(){
      $('#glassWidth').html('');
          if($('#typeOfGlass').val()=='Joining'){
            $('#glassWidth').append('<option value="">Select Earning Type</option>');
            $('#glassWidth').append('<option value="Signup">Signup</option>');
            $('#glassWidth').append('<option value="Refferal">Refferal(Introducer)</option>');
            $('#glassWidth').append('<option value="Pair">Incentive(Pair)</option>');
