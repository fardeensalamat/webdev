...
<div class="col-sm-10">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Write Reason of rejection of  {{$work->subscriber ? $work->subscriber->name : ''}} ({{$work->subscriber ? $work->subscriber->subscription_code : ''}}) work (Job Id {{$work->job ? $work->job->id : ''}})</h3>
        </div>
        <div class="card-body">
