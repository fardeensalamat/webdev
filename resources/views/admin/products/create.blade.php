...
<div class="col-md-6">
  <div class="card">
    <div class="card-body">
      ...
      <form action="{{route('admin.productInformationAdd',$product)}}" class="" method="POST">
        @csrf
        <div class="form-group">
          ...
          @endif
          <input type="text" name="name" value="{{old('name')}}" class="form-control" placeholder="Enter Brand Name">
        </div>
        ...
        <div class="form-group">
          ...
          @endif
          <input type="text" name="excerpt" value="{{old('excerpt')}}" class="form-control" placeholder="Enter  Brand Meta Title">
        </div>
        ...
        <div class="form-group">
          ...
          @endif
          <textarea name="description" rows="3" class="form-control summernote" placeholder="Write Description">{!!old('description')!!}</textarea>
        </div>
