...
return [
    ...
    */
    ...
    'paths' => [
        ...
        public_path('storage/product/serviceproduct'),
        public_path('storage/product/serviceproduct/galary'),
        ...
        public_path('storage/user/profile/cover'),
        public_path('storage/blog'),
        public_path('storage/user/note'),
        public_path('storage/product/serviceitems'),
        public_path('storage/product/courseitems'),
        public_path('storage/suggesion'),
        public_path('storage/user/deliveryman'),
        public_path('storage/user/softcomcandidate'),
        public_path('storage/slider'),
        public_path('storage/employeereport'),
        public_path('storage/toppriority'),
        public_path('storage/valuedcustomer')
    ...
    */
    ...
    'templates' => array(
        ...
        'slider' => 'App\ImageFilters\SliderHome',
    ),
